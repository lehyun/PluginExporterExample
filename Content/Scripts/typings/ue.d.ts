...
declare type EImpactDamageOverride = 'IDO_None' | 'IDO_On' | 'IDO_Off' | 'IDO_MAX';
declare var EImpactDamageOverride : { IDO_None:'IDO_None',IDO_On:'IDO_On',IDO_Off:'IDO_Off',IDO_MAX:'IDO_MAX', };
...
declare class DestructibleComponent extends SkinnedMeshComponent { 
	...
	VictoryDestructible_DestroyChunk(HitItem: number): boolean;
	static VictoryDestructible_DestroyChunk(DestructibleComp: DestructibleComponent,HitItem: number): boolean;
}
...
declare class DestructibleChunkParamsProxy extends UObject { 
	DestructibleMesh: DestructibleMesh;
	ChunkIndex: number;
	ChunkParams: DestructibleChunkParameters;
	static Load(ResourceName: string): DestructibleChunkParamsProxy;
	static Find(Outer: UObject, ResourceName: string): DestructibleChunkParamsProxy;
	static GetDefaultObject(): DestructibleChunkParamsProxy;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DestructibleChunkParamsProxy;
	static C(Other: UObject | any): DestructibleChunkParamsProxy;
}
...
declare class TKMathFunctionLibrary extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): TKMathFunctionLibrary;
	static Find(Outer: UObject, ResourceName: string): TKMathFunctionLibrary;
	static GetDefaultObject(): TKMathFunctionLibrary;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TKMathFunctionLibrary;
	static VectorRadiansToDegrees(RadVector: Vector): Vector;
	static VectorDegreesToRadians(DegVector: Vector): Vector;
	static SphereBoxIntersection(SphereOrigin: Vector,SphereRadius: number,BoxOrigin: Vector,BoxExtent: Vector): boolean;
	static SignedDistancePlanePoint(PlaneNormal: Vector,planePoint: Vector,Point: Vector): number;
	static SetVectorLength(A: Vector,Size: number): Vector;
	static SetCenterOfMassOffset(Target: PrimitiveComponent,Offset: Vector,BoneName: string): void;
	static RoundToUpperMultiple(A: number,Multiple: number,skipSelf: boolean): number;
	static RoundToNearestMultiple(A: number,Multiple: number): number;
	static RoundToLowerMultiple(A: number,Multiple: number,skipSelf: boolean): number;
	static ProjectPointOnLine(LineOrigin: Vector,LineDirection: Vector,Point: Vector): Vector;
	static PointOnWhichSideOfLineSegment(LinePoint1: Vector,LinePoint2: Vector,Point: Vector): number;
	static NegateVector2D(A: Vector2D): Vector2D;
	static NegateInt(A: number): number;
	static NegateFloat(A: number): number;
	static LineToLineIntersection(IntersectionPoint?: Vector,LinePoint1?: Vector,LineDir1?: Vector,LinePoint2?: Vector,LineDir2?: Vector): {IntersectionPoint: Vector, $: boolean};
	static LineExtentBoxIntersection(inBox: Box,Start: Vector,End: Vector,Extent: Vector,HitLocation?: Vector,HitNormal?: Vector,HitTime?: number): {HitLocation: Vector, HitNormal: Vector, HitTime: number, $: boolean};
	static IsPowerOfTwo(X: number): boolean;
	static IsPointInsideBox(Point: Vector,BoxOrigin: Vector,BoxExtent: Vector): boolean;
	static IsMultipleOf(A: number,Multiple: number): boolean;
	static IsLineInsideSphere(LineStart: Vector,LineDir: Vector,LineLength: number,SphereOrigin: Vector,SphereRadius: number): boolean;
	static IsEvenNumber(A: number): boolean;
	static GridSnap(A: Vector,Grid: number): Vector;
	static GetVelocityAtPoint(Target: PrimitiveComponent,Point: Vector,BoneName: string,DrawDebugInfo: boolean): Vector;
	static GetConsoleVariableInt(VariableName: string): number;
	static GetConsoleVariableFloat(VariableName: string): number;
	static ConvertPhysicsLinearVelocity(Velocity: Vector,SpeedUnit: ESpeedUnit): number;
	static ConvertAnchorToAnchor(WorldContextObject: UObject,CurrentAnchor: Anchors,Offsets: Margin,TargetAnchor: Anchors,ConvertedOffsets?: Margin): {ConvertedOffsets: Margin};
	static ClosestPointsOnTwoLines(closestPointLine1?: Vector,closestPointLine2?: Vector,LinePoint1?: Vector,lineVec1?: Vector,LinePoint2?: Vector,lineVec2?: Vector): {closestPointLine1: Vector, closestPointLine2: Vector, $: boolean};
	static ClosestPointsOfLineSegments(Line1Start: Vector,Line1End: Vector,Line2Start: Vector,Line2End: Vector,LinePoint1?: Vector,LinePoint2?: Vector): {LinePoint1: Vector, LinePoint2: Vector};
	static ClosestPointOnSphereToLine(SphereOrigin: Vector,SphereRadius: number,LineOrigin: Vector,LineDir: Vector): Vector;
	static ClosestPointOnLineSeqment(Point: Vector,LineStart: Vector,LineEnd: Vector): Vector;
	static AreLineSegmentsCrossing(pointA1: Vector,pointA2: Vector,pointB1: Vector,pointB2: Vector): boolean;
	static C(Other: UObject | any): TKMathFunctionLibrary;
}

declare type EJoyImageFormats = 'JPG' | 'PNG' | 'BMP' | 'ICO' | 'EXR' | 'ICNS' | 'EJoyImageFormats_MAX';
declare var EJoyImageFormats : { JPG:'JPG',PNG:'PNG',BMP:'BMP',ICO:'ICO',EXR:'EXR',ICNS:'ICNS',EJoyImageFormats_MAX:'EJoyImageFormats_MAX', };
declare type EJoyGraphicsFullScreen = 'FullScreen' | 'WindowedFullScreen' | 'WindowedFullScreenPerformance' | 'EJoyGraphicsFullScreen_Max';
declare var EJoyGraphicsFullScreen : { FullScreen:'FullScreen',WindowedFullScreen:'WindowedFullScreen',WindowedFullScreenPerformance:'WindowedFullScreenPerformance',EJoyGraphicsFullScreen_Max:'EJoyGraphicsFullScreen_Max', };
declare class VictoryBPFunctionLibrary extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): VictoryBPFunctionLibrary;
	static Find(Outer: UObject, ResourceName: string): VictoryBPFunctionLibrary;
	static GetDefaultObject(): VictoryBPFunctionLibrary;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VictoryBPFunctionLibrary;
	static WorldType__InPIEWorld(WorldContextObject: UObject): boolean;
	static WorldType__InGameInstanceWorld(WorldContextObject: UObject): boolean;
	static WorldType__InEditorWorld(WorldContextObject: UObject): boolean;
	static WidgetIsChildOf(ChildWidget: Widget,PossibleParent: Widget): boolean;
	static WidgetGetParentOfClass(ChildWidget: Widget,WidgetClass: UnrealEngineClass): UserWidget;
	static WidgetGetChildrenOfClass(ParentWidget: Widget,ChildWidgets?: UserWidget[],WidgetClass?: UnrealEngineClass,bImmediateOnly?: boolean): {ChildWidgets: UserWidget[]};
	static Visibility__GetRenderedActors(WorldContextObject: UObject,CurrentlyRenderedActors?: Actor[],MinRecentTime?: number): {CurrentlyRenderedActors: Actor[]};
	static Visibility__GetNotRenderedActors(WorldContextObject: UObject,CurrentlyNotRenderedActors?: Actor[],MinRecentTime?: number): {CurrentlyNotRenderedActors: Actor[]};
	static ViewportPositionDeproject(WorldContextObject: UObject,ViewportPosition: Vector2D,OutWorldOrigin?: Vector,OutWorldDirection?: Vector): {OutWorldOrigin: Vector, OutWorldDirection: Vector, $: boolean};
	static Viewport__SetMousePosition(ThePC: PlayerController,PosX: number,PosY: number): boolean;
	static Viewport__GetMousePosition(ThePC: PlayerController,PosX?: number,PosY?: number): {PosX: number, PosY: number, $: boolean};
	static Viewport__GetCenterOfViewport(ThePC: PlayerController,PosX?: number,PosY?: number): {PosX: number, PosY: number, $: boolean};
	static Viewport__EnableWorldRendering(ThePC: PlayerController,RenderTheWorld: boolean): boolean;
	static VictorySoundVolumeChange(SoundClassObject: SoundClass,NewVolume: number): boolean;
	static VictorySortIntArray(IntArray?: number[],IntArrayRef?: number[]): {IntArray: number[], IntArrayRef: number[]};
	static VictorySortFloatArray(FloatArray?: number[],FloatArrayRef?: number[]): {FloatArray: number[], FloatArrayRef: number[]};
	static VictorySimulateMouseWheel(Delta: number): void;
	static VictorySimulateKeyPress(ThePC: PlayerController,Key: Key,EventType: EInputEvent): void;
	static VictorySetCustomConfigVar_Vector2D(SectionName: string,VariableName: string,Value: Vector2D): void;
	static VictorySetCustomConfigVar_Vector(SectionName: string,VariableName: string,Value: Vector): void;
	static VictorySetCustomConfigVar_String(SectionName: string,VariableName: string,Value: string): void;
	static VictorySetCustomConfigVar_Rotator(SectionName: string,VariableName: string,Value: Rotator): void;
	static VictorySetCustomConfigVar_Int(SectionName: string,VariableName: string,Value: number): void;
	static VictorySetCustomConfigVar_Float(SectionName: string,VariableName: string,Value: number): void;
	static VictorySetCustomConfigVar_Color(SectionName: string,VariableName: string,Value: LinearColor): void;
	static VictorySetCustomConfigVar_Bool(SectionName: string,VariableName: string,Value: boolean): void;
	static VictoryRemoveAxisKeyBind(ToRemove: VictoryInputAxis): void;
	static VictoryRemoveActionKeyBind(ToRemove: VictoryInput): void;
	static VictoryReBindAxisKey(Original: VictoryInputAxis,NewBinding: VictoryInputAxis): boolean;
	static VictoryReBindActionKey(Original: VictoryInput,NewBinding: VictoryInput): boolean;
	static VictoryPhysics_UpdateAngularDamping(CompToUpdate: PrimitiveComponent,NewAngularDamping: number): boolean;
	static VictoryPaths__WindowsNoEditorDir(): string;
	static VictoryPaths__Win64Dir_BinaryLocation(): string;
	static VictoryPaths__ScreenShotsDir(): string;
	static VictoryPaths__SavedDir(): string;
	static VictoryPaths__LogsDir(): string;
	static VictoryPaths__GameRootDirectory(): string;
	static VictoryPaths__ConfigDir(): string;
	static VictoryLoadLevelInstance(WorldContextObject: UObject,MapFolderOffOfContent: string,LevelName: string,InstanceNumber: number,Location: Vector,Rotation: Rotator,Success?: boolean): {Success: boolean, $: LevelStreaming};
	static VictoryISM_GetAllVictoryISMActors(WorldContextObject: UObject,Out?: VictoryISM[]): {Out: VictoryISM[]};
	static VictoryISM_ConvertToVictoryISMActors(WorldContextObject: UObject,ActorClass: UnrealEngineClass,CreatedISMActors?: VictoryISM[],DestroyOriginalActors?: boolean,MinCountToCreateISM?: number): {CreatedISMActors: VictoryISM[]};
	static VictoryIsApplicationRunning(ProcessId: number): boolean;
	static VictoryIntPlusEquals(int?: number,Add?: number,IntOut?: number): {int: number, IntOut: number};
	static VictoryIntMinusEquals(int?: number,Sub?: number,IntOut?: number): {int: number, IntOut: number};
	static VictoryGetVictoryInputAxis(KeyEvent: KeyEvent): VictoryInputAxis;
	static VictoryGetVictoryInput(KeyEvent: KeyEvent): VictoryInput;
	static VictoryGetSoundVolume(SoundClassObject: SoundClass): number;
	static VictoryGetCustomConfigVar_Vector2D(SectionName: string,VariableName: string,IsValid?: boolean): {IsValid: boolean, $: Vector2D};
	static VictoryGetCustomConfigVar_Vector(SectionName: string,VariableName: string,IsValid?: boolean): {IsValid: boolean, $: Vector};
	static VictoryGetCustomConfigVar_String(SectionName: string,VariableName: string,IsValid?: boolean): {IsValid: boolean, $: string};
	static VictoryGetCustomConfigVar_Rotator(SectionName: string,VariableName: string,IsValid?: boolean): {IsValid: boolean, $: Rotator};
	static VictoryGetCustomConfigVar_Int(SectionName: string,VariableName: string,IsValid?: boolean): {IsValid: boolean, $: number};
	static VictoryGetCustomConfigVar_Float(SectionName: string,VariableName: string,IsValid?: boolean): {IsValid: boolean, $: number};
	static VictoryGetCustomConfigVar_Color(SectionName: string,VariableName: string,IsValid?: boolean): {IsValid: boolean, $: LinearColor};
	static VictoryGetCustomConfigVar_Bool(SectionName: string,VariableName: string,IsValid?: boolean): {IsValid: boolean, $: boolean};
	static VictoryGetApplicationName(ProcessId: number): string;
	static VictoryGetAllAxisKeyBindings(Bindings?: VictoryInputAxis[]): {Bindings: VictoryInputAxis[]};
	static VictoryGetAllAxisAndActionMappingsForKey(Key: Key,ActionBindings?: VictoryInput[],AxisBindings?: VictoryInputAxis[]): {ActionBindings: VictoryInput[], AxisBindings: VictoryInputAxis[]};
	static VictoryGetAllActionKeyBindings(Bindings?: VictoryInput[]): {Bindings: VictoryInput[]};
	static VictoryFloatPlusEquals(float?: number,Add?: number,FloatOut?: number): {float: number, FloatOut: number};
	static VictoryFloatMinusEquals(float?: number,Sub?: number,FloatOut?: number): {float: number, FloatOut: number};
	static VictoryDestructible_DestroyChunk(DestructibleComp: DestructibleComponent,HitItem: number): boolean;
	static VictoryCreateProc(ProcessId?: number,FullPathOfProgramToRun?: string,CommandlineArgs?: string[],Detach?: boolean,Hidden?: boolean,Priority?: number,OptionalWorkingDirectory?: string): {ProcessId: number};
	static VictoryAppendInline(string?: string,ToAppend?: string,Result?: string,AppendNewline?: boolean): {string: string, Result: string};
	static Victory_SecondsToHoursMinutesSeconds(Seconds: number,TrimZeroes: boolean): string;
	static Victory_SaveStringToOSClipboard(ToClipboard: string): void;
	static Victory_SavePixels(FullFilePath: string,Width: number,Height: number,ImagePixels: LinearColor[],SaveAsBMP: boolean,SRGB: boolean,ErrorString?: string): {ErrorString: string, $: boolean};
	static Victory_LoadTexture2D_FromFile_Pixels(FullFilePath: string,ImageFormat: EJoyImageFormats,IsValid?: boolean,Width?: number,Height?: number,OutPixels?: LinearColor[]): {IsValid: boolean, Width: number, Height: number, OutPixels: LinearColor[], $: Texture2D};
	static Victory_LoadTexture2D_FromFile(FullFilePath: string,ImageFormat: EJoyImageFormats,IsValid?: boolean,Width?: number,Height?: number): {IsValid: boolean, Width: number, Height: number, $: Texture2D};
	static Victory_GetStringFromOSClipboard(FromClipboard?: string): {FromClipboard: string};
	static Victory_GetPixelsArrayFromT2D(T2D: Texture2D,TextureWidth?: number,TextureHeight?: number,PixelArray?: LinearColor[]): {TextureWidth: number, TextureHeight: number, PixelArray: LinearColor[], $: boolean};
	static Victory_GetPixelFromT2D(T2D: Texture2D,X: number,Y: number,PixelColor?: LinearColor): {PixelColor: LinearColor, $: boolean};
	static Victory_GetGRHIAdapterName(): string;
	static Victory_GetGPUInfo(DeviceDescription?: string,Provider?: string,DriverVersion?: string,DriverDate?: string): {DeviceDescription: string, Provider: string, DriverVersion: string, DriverDate: string};
	static Victory_GetGPUBrand(): string;
	static Victory_Get_Pixel(Pixels: LinearColor[],ImageHeight: number,X: number,Y: number,FoundColor?: LinearColor): {FoundColor: LinearColor, $: boolean};
	static Victory_AI_MoveToWithFilter(Pawn: Pawn,Dest: Vector,FilterClass: UnrealEngineClass,AcceptanceRadius: number,bProjectDestinationToNavigation: boolean,bStopOnOverlap: boolean,bCanStrafe: boolean): EPathFollowingRequestResult;
	static VerticalFOV(HorizontalFOV: number,AspectRatio: number): number;
	...
	static UTCToLocal(UTCTime: DateTime,LocalTime?: DateTime): {LocalTime: DateTime};
	static UnloadStreamingLevel(LevelInstance: LevelStreamingKismet): void;
	TransformVectorToActorSpaceAngle(Actor: Actor,InVector: Vector): Rotator;
	TransformVectorToActorSpace(Actor: Actor,InVector: Vector): Vector;
	static Traces__CharacterMeshTrace___ClosestSocket(WorldContextObject: UObject,TraceOwner: Actor,TraceStart: Vector,TraceEnd: Vector,OutImpactPoint?: Vector,OutImpactNormal?: Vector,ClosestSocketName?: string,SocketLocation?: Vector,IsValid?: boolean): {OutImpactPoint: Vector, OutImpactNormal: Vector, ClosestSocketName: string, SocketLocation: Vector, IsValid: boolean, $: Actor};
	static Traces__CharacterMeshTrace___ClosestBone(TraceOwner: Actor,TraceStart: Vector,TraceEnd: Vector,OutImpactPoint?: Vector,OutImpactNormal?: Vector,ClosestBoneName?: string,ClosestBoneLocation?: Vector,IsValid?: boolean): {OutImpactPoint: Vector, OutImpactNormal: Vector, ClosestBoneName: string, ClosestBoneLocation: Vector, IsValid: boolean, $: Actor};
	static TraceData__GetTraceDataFromSkeletalMeshSocket(TraceStart?: Vector,TraceEnd?: Vector,Mesh?: SkeletalMeshComponent,TraceRotation?: Rotator,TraceLength?: number,Socket?: string,DrawTraceData?: boolean,TraceDataColor?: LinearColor,TraceDataThickness?: number): {TraceStart: Vector, TraceEnd: Vector, $: boolean};
	static TraceData__GetTraceDataFromCharacterSocket(TraceStart?: Vector,TraceEnd?: Vector,TheCharacter?: Actor,TraceRotation?: Rotator,TraceLength?: number,Socket?: string,DrawTraceData?: boolean,TraceDataColor?: LinearColor,TraceDataThickness?: number): {TraceStart: Vector, TraceEnd: Vector, $: boolean};
	static Text_ToInt(text: string,UseDotForThousands: boolean): number;
	static Text_ToFloat(text: string,UseDotForThousands: boolean): number;
	static Text_IsNumeric(text: string): boolean;
	static StringIsEmpty(Target: string): boolean;
	static StringConversion__GetFloatAsStringWithPrecision(TheFloat: number,TheString?: string,Precision?: number,IncludeLeadingZero?: boolean): {TheString: string};
	static String__ExplodeString(OutputStrings?: string[],InputString?: string,Separator?: string,Limit?: number,bTrimElements?: boolean): {OutputStrings: string[]};
	static String__CombineStrings_Multi(A: string,B: string): string;
	static String__CombineStrings(StringFirst: string,StringSecond: string,Separator: string,StringFirstLabel: string,StringSecondLabel: string): string;
	static SpawnActorIntoLevel(WorldContextObject: UObject,ActorClass: UnrealEngineClass,Level: string,Location: Vector,Rotation: Rotator,SpawnEvenIfColliding: boolean): Actor;
	static SetGenericTeamId(Target: Actor,NewTeamId: number): void;
	static SetComponentTickRate(Component: ActorComponent,Seconds: number): void;
	static SetBloomIntensity(PostProcessVolume: PostProcessVolume,Intensity: number): void;
	static ServerTravel(WorldContextObject: UObject,MapName: string,bNotifyPlayers: boolean): void;
	static Selection_SelectionBox(WorldContextObject: UObject,SelectedActors?: Actor[],AnchorPoint?: Vector2D,DraggedPoint?: Vector2D,ClassFilter?: UnrealEngineClass): {SelectedActors: Actor[]};
	static seedRandWithTime(): void;
	static seedRandWithEntropy(): void;
	static seedRand(Seed: number): void;
	static ScreenShots_Rename_Move_Most_Recent(OriginalFileName?: string,NewName?: string,NewAbsoluteFolderPath?: string,HighResolution?: boolean): {OriginalFileName: string, $: boolean};
	static SaveGameObject_GetAllSaveSlotFileNames(Filenames?: string[]): {Filenames: string[]};
	static Rendering__UnFreezeGameRendering(): void;
	static Rendering__FreezeGameRendering(): void;
	static RemoveFromStreamingLevels(WorldContextObject: UObject,LevelInstanceInfo: LevelStreamInstanceInfo): void;
	static RemoveAllWidgetsOfClass(WorldContextObject: UObject,WidgetClass: UnrealEngineClass): void;
	static RealWorldTime__GetTimePassedSincePreviousTime(PreviousTime: string,Milliseconds?: number,Seconds?: number,Minutes?: number,Hours?: number): {Milliseconds: number, Seconds: number, Minutes: number, Hours: number};
	static RealWorldTime__GetDifferenceBetweenTimes(PreviousTime1: string,PreviousTime2: string,Milliseconds?: number,Seconds?: number,Minutes?: number,Hours?: number): {Milliseconds: number, Seconds: number, Minutes: number, Hours: number};
	static RealWorldTime__GetCurrentOSTime(Milliseconds?: number,Seconds?: number,Minutes?: number,Hours12?: number,Hours24?: number,Day?: number,Month?: number,Year?: number): {Milliseconds: number, Seconds: number, Minutes: number, Hours12: number, Hours24: number, Day: number, Month: number, Year: number, $: string};
	static RandInt_uniDis_MT(): number;
	static RandInt_uniDis(): number;
	static RandInt_MINMAX_uniDis_MT(iMin: number,iMax: number): number;
	static RandInt_MINMAX_uniDis(iMin: number,iMax: number): number;
	static RandFloat_uniDis_MT(): number;
	static RandFloat_uniDis(): number;
	static RandFloat_MINMAX_uniDis_MT(iMin: number,iMax: number): number;
	static RandFloat_MINMAX_uniDis(iMin: number,iMax: number): number;
	static RandBool_Bernoulli_MT(fBias: number): boolean;
	static RandBool_Bernoulli(fBias: number): boolean;
	static ProjectWorldToScreenPosition(WorldLocation: Vector): Vector2D;
	static PointDistanceToPlane(Plane: Plane,Point: Vector,Distance?: number): {Distance: number};
	static PlaySoundAttachedFromFile(FilePath: string,AttachToComponent: SceneComponent,AttachPointName: string,Location: Vector,LocationType: EAttachLocation,bStopWhenAttachedToDestroyed: boolean,VolumeMultiplier: number,PitchMultiplier: number,StartTime: number,AttenuationSettings: SoundAttenuation): AudioComponent;
	static PlaySoundAtLocationFromFile(WorldContextObject: UObject,FilePath: string,Location: Vector,VolumeMultiplier: number,PitchMultiplier: number,StartTime: number,AttenuationSettings: SoundAttenuation): void;
	static PlayerState_GetPlayerID(ThePC: PlayerController,PlayerId?: number): {PlayerId: number, $: boolean};
	static PlayerController_GetControllerID(ThePC: PlayerController,ControllerId?: number): {ControllerId: number, $: boolean};
	static Physics__UpdateCharacterCameraToRagdollLocation(TheCharacter: Actor,HeightOffset: number,InterpSpeed: number): boolean;
	static Physics__LeaveRagDoll(TheCharacter: Actor,SetToFallingMovementMode: boolean,HeightAboveRBMesh: number,InitLocation: Vector,InitRotation: Rotator): boolean;
	static Physics__IsRagDoll(TheCharacter: Actor): boolean;
	static Physics__InitializeVictoryRagDoll(TheCharacter: Actor,InitLocation?: Vector,InitRotation?: Rotator): {InitLocation: Vector, InitRotation: Rotator, $: boolean};
	static Physics__GetLocationofRagDoll(TheCharacter: Actor,RagdollLocation?: Vector): {RagdollLocation: Vector, $: boolean};
	static Physics__EnterRagDoll(TheCharacter: Actor): boolean;
	static OptionsMenu__GetDisplayAdapterScreenResolutions(Widths?: number[],Heights?: number[],RefreshRates?: number[],IncludeRefreshRates?: boolean): {Widths: number[], Heights: number[], RefreshRates: number[], $: boolean};
	static OperatingSystem__GetCurrentPlatform(Windows_?: boolean,Mac?: boolean,Linux?: boolean,IOS?: boolean,Android?: boolean,Android_ARM?: boolean,Android_Vulkan?: boolean,PS4?: boolean,XboxOne?: boolean,HTML5?: boolean,Apple?: boolean): {Windows_: boolean, Mac: boolean, Linux: boolean, IOS: boolean, Android: boolean, Android_ARM: boolean, Android_Vulkan: boolean, PS4: boolean, XboxOne: boolean, HTML5: boolean, Apple: boolean};
	static Open_URL_In_Web_Browser(TheURL: string): void;
	static NotEqual_Vector2DVector2D(A: Vector2D,B: Vector2D,ErrorTolerance: number): boolean;
	static Mobility__SetSceneCompMobility(SceneComp: SceneComponent,NewMobility: EComponentMobility): boolean;
	...
	static Loops_ResetBPRunawayCounter(): void;
	static LoadTexture2D_FromFileByExtension(ImagePath: string,IsValid?: boolean,OutWidth?: number,OutHeight?: number): {IsValid: boolean, OutWidth: number, OutHeight: number, $: Texture2D};
	static LoadTexture2D_FromDDSFile(FullFilePath: string): Texture2D;
	static LoadStringFromFile(Result?: string,FullFilePath?: string): {Result: string, $: boolean};
	static LoadStringArrayFromFile(StringArray?: string[],ArraySize?: number,FullFilePath?: string,ExcludeEmptyLines?: boolean): {StringArray: string[], ArraySize: number, $: boolean};
	static LoadObjectFromAssetPath(ObjectClass: UnrealEngineClass,Path: string,IsValid?: boolean): {IsValid: boolean, $: UObject};
	static LensFlare__GetLensFlareOffsets(PlayerController: PlayerController,LightSource: Actor,PitchOffset?: number,YawOffset?: number,RollOffset?: number): {PitchOffset: number, YawOffset: number, RollOffset: number, $: boolean};
	static JoyIsKey(KeyEvent: KeyEvent,Key: Key,Ctrl?: boolean,Shift?: boolean,Alt?: boolean,Cmd?: boolean,Match?: boolean): {Ctrl: boolean, Shift: boolean, Alt: boolean, Cmd: boolean, Match: boolean};
	static JoyGraphicsSettings__FullScreen_Set(NewSetting: EJoyGraphicsFullScreen): void;
	static JoyGraphicsSettings__FullScreen_Get(): EJoyGraphicsFullScreen;
	static JoyFileIO_GetFilesInRootAndAllSubFolders(Files?: string[],RootFolderFullPath?: string,Ext?: string): {Files: string[], $: boolean};
	static JoyFileIO_GetFiles(Files?: string[],RootFolderFullPath?: string,Ext?: string): {Files: string[], $: boolean};
	static IsWidgetOfClassInViewport(WorldContextObject: UObject,WidgetClass: UnrealEngineClass): boolean;
	static IsStandAlone(WorldContextObject: UObject): boolean;
	static IsPointOnPlane(Plane: Plane,Point: Vector,Tolerance: number): boolean;
	static IsAlphaNumeric(string: string): boolean;
	static InsertChildAt(Parent: Widget,index: number,Content: Widget): PanelSlot;
	static HorizontalFOV(VerticalFOV: number,AspectRatio: number): number;
	static HideStreamingLevel(LevelInstance: LevelStreamingKismet): void;
	static HasSubstring(SearchIn: string,Substring: string,SearchCase: ESearchCase,SearchDir: ESearchDir): boolean;
	static GraphicsSettings__SetFrameRateToBeUnbound(): void;
	static GraphicsSettings__SetFrameRateCap(NewValue: number): void;
	static GetWidgetFromName(ParentUserWidget: UserWidget,Name: string): Widget;
	static GetViewportPositionHitResultByChannel(WorldContextObject: UObject,ViewportPosition: Vector2D,TraceChannel: ECollisionChannel,bTraceComplex: boolean,OutHitResult?: HitResult): {OutHitResult: HitResult, $: boolean};
	static GetViewportPosition(WorldContextObject: UObject,ScreenPosition: Vector2D,OutViewportPosition?: Vector2D): {OutViewportPosition: Vector2D, $: boolean};
	static GetVectorRelativeLocation(ParentLocation: Vector,ParentRotation: Rotator,ChildLocation: Vector): Vector;
	static GetUTCFromUnixTimeStamp(UnixTimeStamp: number,UTCTime?: DateTime): {UTCTime: DateTime};
	static GetUserDisplayAdapterBrand(IsAMD?: boolean,IsNvidia?: boolean,IsIntel?: boolean,IsUnknown?: boolean,UnknownId?: number): {IsAMD: boolean, IsNvidia: boolean, IsIntel: boolean, IsUnknown: boolean, UnknownId: number};
	static GetUnixTimeStamp(UTCTime: DateTime): number;
	static GetTimeInPlay(Actor: Actor): number;
	static GetTimeAlive(Target: Actor): number;
	static GetStaticMeshVertexLocations(Comp: StaticMeshComponent,VertexPositions?: Vector[]): {VertexPositions: Vector[], $: boolean};
	static GetSoundWaveFromFile(FilePath: string): SoundWave;
	static GetRotatorRelativeRotation(ParentRotation: Rotator,ChildRotation: Rotator): Rotator;
	static GetPlayerUniqueNetID(): number;
	static GetPlayerStart(WorldContextObject: UObject,PlayerStartName: string): PlayerStart;
	static GetObjectPath(Obj: UObject): string;
	static GetNamesOfLoadedLevels(WorldContextObject: UObject,NamesOfLoadedLevels?: string[]): {NamesOfLoadedLevels: string[]};
	static GetLevelInstanceInfo(LevelInstance: LevelStreamingKismet): LevelStreamInstanceInfo;
	static GetHeadMountedDisplayDeviceType(): string;
	static GetGenericTeamId(Target: Actor): number;
	static GetFirstWidgetOfClass(WorldContextObject: UObject,WidgetClass: UnrealEngineClass,TopLevelOnly: boolean): UserWidget;
	static GetDistanceToCollision(CollisionComponent: PrimitiveComponent,Point: Vector,ClosestPointOnCollision?: Vector): {ClosestPointOnCollision: Vector, $: number};
	static GetDistanceBetweenComponentSurfaces(CollisionComponent1: PrimitiveComponent,CollisionComponent2: PrimitiveComponent,PointOnSurface1?: Vector,PointOnSurface2?: Vector): {PointOnSurface1: Vector, PointOnSurface2: Vector, $: number};
	static GetCreationTime(Target: Actor): number;
	static GetComponentRelativeRotation(ParentComponent: SceneComponent,ChildComponent: SceneComponent): Rotator;
	static GetComponentRelativeLocation(ParentComponent: SceneComponent,ChildComponent: SceneComponent): Vector;
	static GetCommandLine(): string;
	static GetClosestActorOfClassInRadiusOfLocation(WorldContextObject: UObject,ActorClass: UnrealEngineClass,Center: Vector,Radius: number,IsValid?: boolean): {IsValid: boolean, $: Actor};
	static GetClosestActorOfClassInRadiusOfActor(WorldContextObject: UObject,ActorClass: UnrealEngineClass,ActorCenter: Actor,Radius: number,IsValid?: boolean): {IsValid: boolean, $: Actor};
	static GetBoxContainingWorldPoints(Points: Vector[],Center?: Vector,Extent?: Vector): {Center: Vector, Extent: Vector};
	static GetAllWidgetsOfClass(WorldContextObject: UObject,WidgetClass: UnrealEngineClass,FoundWidgets?: UserWidget[],TopLevelOnly?: boolean): {FoundWidgets: UserWidget[]};
	static GetAllBoneNamesBelowBone(SkeletalMeshComp: SkeletalMeshComponent,StartingBoneName: string,BoneNames?: string[]): {BoneNames: string[], $: number};
	static GetActorRelativeRotation(ParentActor: Actor,ChildActor: Actor): Rotator;
	static GetActorRelativeLocation(ParentActor: Actor,ChildActor: Actor): Vector;
	static FlushPressedKeys(PlayerController: PlayerController): void;
	static FlashGameOnTaskBar(PC: PlayerController,FlashContinuous: boolean,MaxFlashCount: number,FlashFrequencyMilliseconds: number): void;
	static FileIO__SaveStringTextToFile(SaveDirectory: string,JoyfulFileName: string,SaveText: string,AllowOverWriting: boolean): boolean;
	static FileIO__SaveStringArrayToFile(SaveDirectory: string,JoyfulFileName: string,SaveText: string[],AllowOverWriting: boolean): boolean;
	static EqualEqual_Vector2DVector2D(A: Vector2D,B: Vector2D,ErrorTolerance: number): boolean;
	static DrawCircle(WorldContextObject: UObject,Center: Vector,Radius: number,NumPoints: number,Thickness: number,LineColor: LinearColor,YAxis: Vector,ZAxis: Vector,Duration: number,PersistentLines: boolean): void;
	static Draw__Thick3DLineFromSocket(Mesh: SkeletalMeshComponent,Endpoint: Vector,Socket: string,LineColor: LinearColor,Thickness: number,Duration: number): void;
	static Draw__Thick3DLineFromCharacterSocket(TheCharacter: Actor,Endpoint: Vector,Socket: string,LineColor: LinearColor,Thickness: number,Duration: number): void;
	static Draw__Thick3DLineBetweenActors(StartActor: Actor,EndActor: Actor,LineColor: LinearColor,Thickness: number,Duration: number): void;
	static DoesMaterialHaveParameter(Mat: MaterialInterface,Parameter: string): boolean;
	static DistanceToSurface__DistaceOfPointToMeshSurface(TheSMA: StaticMeshActor,TestPoint: Vector,ClosestSurfacePoint?: Vector): {ClosestSurfacePoint: Vector, $: number};
	static Data__GetCharacterBoneLocations(TheCharacter: Actor,BoneLocations?: Vector[]): {BoneLocations: Vector[], $: boolean};
	static CreateTextureRenderTarget2D(Width: number,Height: number,ClearColor: LinearColor,Gamma: number): TextureRenderTarget2D;
	static CreatePrimitiveComponent(WorldContextObject: UObject,CompClass: UnrealEngineClass,Name: string,Location: Vector,Rotation: Rotator): PrimitiveComponent;
	static CreatePlane(Center: Vector,Normal: Vector): Plane;
	static CreateObject(WorldContextObject: UObject,TheObjectClass: UnrealEngineClass): UObject;
	static CreateMD5Hash(FileToHash: string,FileToStoreHashTo: string): boolean;
	static CountOccurrancesOfSubString(Source: string,Substring: string,SearchCase: ESearchCase): number;
	static Conversions__VectorToRotator(TheVector: Vector): Rotator;
	static Conversions__StringToVector(string: string,ConvertedVector?: Vector,IsValid?: boolean): {ConvertedVector: Vector, IsValid: boolean};
	static Conversions__StringToRotator(string: string,ConvertedRotator?: Rotator,IsValid?: boolean): {ConvertedRotator: Rotator, IsValid: boolean};
	static Conversions__StringToColor(string: string,ConvertedColor?: LinearColor,IsValid?: boolean): {ConvertedColor: LinearColor, IsValid: boolean};
	static Conversions__RotatorToVector(TheRotator: Rotator): Vector;
	static Conversions__ColorToString(Color: LinearColor,ColorAsString?: string): {ColorAsString: string};
	static Conversion__FloatToRoundedInteger(IN_Float: number): number;
	static constructRand(): void;
	static Component_PrestreamTextures(Target: MeshComponent,Seconds: number,bEnableStreaming: boolean,CinematicTextureGroups: number): void;
	static CompareMD5Hash(MD5HashFile1: string,MD5HashFile2: string): boolean;
	static Clone__StaticMeshActor(WorldContextObject: UObject,IsValid?: boolean,ToClone?: StaticMeshActor,LocationOffset?: Vector,RotationOffset?: Rotator): {IsValid: boolean, $: StaticMeshActor};
	static ClientWindow__GameWindowIsForeGroundInOS(): boolean;
	static CharacterMovement__SetMaxMoveSpeed(TheCharacter: Character,NewMaxMoveSpeed: number): boolean;
	static Character__GetControllerRotation(TheCharacter: Actor): Rotator;
	static CaptureComponent2D_SaveImage(Target: SceneCaptureComponent2D,ImagePath: string,ClearColour: LinearColor): boolean;
	static CaptureComponent2D_Project(Target: SceneCaptureComponent2D,Location: Vector,OutPixelLocation?: Vector2D): {OutPixelLocation: Vector2D, $: boolean};
	static Capture2D_SaveImage(Target: SceneCapture2D,ImagePath: string,ClearColour: LinearColor): boolean;
	static Capture2D_Project(Target: SceneCapture2D,Location: Vector,OutPixelLocation?: Vector2D): {OutPixelLocation: Vector2D, $: boolean};
	static Calcs__ClosestPointToSourcePoint(Source: Vector,OtherPoints: Vector[],ClosestPoint?: Vector): {ClosestPoint: Vector, $: number};
	static Array_Sort(TargetArray: number[],bAscendingOrder: boolean,VariableName: string): void;
	static Array_IsValidIndex(TargetArray: number[],index: number): boolean;
	static AppendMultiple(A: string,B: string): string;
	static Animation__GetAimOffsetsFromRotation(AnimBPOwner: Actor,TheRotation: Rotator,Pitch?: number,Yaw?: number): {Pitch: number, Yaw: number, $: boolean};
	static Animation__GetAimOffsets(AnimBPOwner: Actor,Pitch?: number,Yaw?: number): {Pitch: number, Yaw: number, $: boolean};
	static AddToStreamingLevels(WorldContextObject: UObject,LevelInstanceInfo: LevelStreamInstanceInfo): void;
	static AddToActorRotation(TheActor: Actor,AddRot: Rotator): void;
	static Actor_PrestreamTextures(Target: Actor,Seconds: number,bEnableStreaming: boolean,CinematicTextureGroups: number): void;
	static Actor__TeleportToActor(ActorToTeleport: Actor,DestinationActor: Actor): boolean;
	static Actor__GetAttachedActors(ParentActor: Actor,ActorsArray?: Actor[]): {ActorsArray: Actor[]};
	static Accessor__GetPlayerController(TheCharacter: Actor,IsValid?: boolean): {IsValid: boolean, $: PlayerController};
	static Accessor__GetNameAsString(TheObject: UObject): string;
	static Accessor__GetCharacterSkeletalMesh(TheCharacter: Actor,IsValid?: boolean): {IsValid: boolean, $: SkeletalMeshComponent};
	static C(Other: UObject | any): VictoryBPFunctionLibrary;
}

declare class VictoryBPHTML extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): VictoryBPHTML;
	static Find(Outer: UObject, ResourceName: string): VictoryBPHTML;
	static GetDefaultObject(): VictoryBPHTML;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VictoryBPHTML;
	static VictoryHTML5_SetCursorVisible(MakeVisible: boolean): void;
	static IsHTML(): boolean;
	static C(Other: UObject | any): VictoryBPHTML;
}

declare class VictorySubtitleCue { 
	SubtitleText: string;
	Time: number;
	clone() : VictorySubtitleCue;
	static C(Other: UObject | any): VictorySubtitleCue;
}

declare class VictoryPC extends PlayerController { 
	static GetDefaultObject(): VictoryPC;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VictoryPC;
	VictoryPlaySpeechSound(Sound: SoundBase,VolumeMultiplier: number,PitchMultiplier: number,StartTime: number): AudioComponent;
	VictoryPC_GetMyIP_SendRequest(): boolean;
	VictoryPC_GetMyIP_DataReceived(YourIP: string): void;
	Subtitles_CPPDelegate(VictorySubtitles: SubtitleCue[],CueDuration: number): void;
	OnVictorySubtitlesQueued(VictorySubtitles: VictorySubtitleCue[],CueDuration: number): void;
	static C(Other: UObject | any): VictoryPC;
}

declare class VictoryTMapComp extends ActorComponent { 
	static Load(ResourceName: string): VictoryTMapComp;
	static Find(Outer: UObject, ResourceName: string): VictoryTMapComp;
	static GetDefaultObject(): VictoryTMapComp;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VictoryTMapComp;
	String_Vector__Remove(Key: string): void;
	String_Vector__Get(Key: string,IsValid?: boolean): {IsValid: boolean, $: Vector};
	String_Vector__Clear(): void;
	String_Vector__AddPair(Key: string,Value: Vector): void;
	String_String__Remove(Key: string): void;
	String_String__Get(Key: string,IsValid?: boolean): {IsValid: boolean, $: string};
	String_String__Clear(): void;
	String_String__AddPair(Key: string,Value: string): void;
	String_Rotator__Remove(Key: string): void;
	String_Rotator__Get(Key: string,IsValid?: boolean): {IsValid: boolean, $: Rotator};
	String_Rotator__Clear(): void;
	String_Rotator__AddPair(Key: string,Value: Rotator): void;
	String_Int__Remove(Key: string): void;
	String_Int__Get(Key: string,IsValid?: boolean): {IsValid: boolean, $: number};
	String_Int__Clear(): void;
	String_Int__AddPair(Key: string,Value: number): void;
	String_Actor__Remove(Key: string): void;
	String_Actor__Get(Key: string,IsValid?: boolean): {IsValid: boolean, $: Actor};
	String_Actor__Clear(): void;
	String_Actor__AddPair(Key: string,Value: Actor): void;
	Int_Vector__Remove(Key: number): void;
	Int_Vector__Get(Key: number,IsValid?: boolean): {IsValid: boolean, $: Vector};
	Int_Vector__Clear(): void;
	Int_Vector__AddPair(Key: number,Value: Vector): void;
	Int_Float__Remove(Key: number,Value: number): void;
	Int_Float__Get(Key: number,IsValid?: boolean): {IsValid: boolean, $: number};
	Int_Float__Clear(): void;
	Int_Float__AddPair(Key: number,Value: number): void;
	static C(Other: UObject | any): VictoryTMapComp;
}

declare class PluginExporterGameModeBase extends GameModeBase { 
	static GetDefaultObject(): PluginExporterGameModeBase;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PluginExporterGameModeBase;
	static C(Other: UObject | any): PluginExporterGameModeBase;
}
